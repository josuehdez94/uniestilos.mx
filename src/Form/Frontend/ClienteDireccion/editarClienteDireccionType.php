...
class editarClienteDireccionType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('codigoPostalColoniaNoMapped', TextType::class,[
                'label' => 'Codigo postal',
                'mapped' => false,
                'data' => $direccion->getCodigoPostalColonia()->getCodigo(),
        ...
        ;
        $formModifier = function (FormInterface $form, $codigoPostal = null, $entityManager = null, $direccion = null) {
            ...
            if(null !== $codigoPostal){
                ...
                if(!empty($codigos)){
                    ...
                    ->add('municipioNoMapped', TextType::class,[
                        'label' => 'Municipio',
                        'mapped' => false,
                        'attr' => ['class' => 'form-control-sm is-invalid', 'disabled' => true, 'value' => 'Codigo postal es invalido']
                    ])
                    ->add('estadoNoMapped', TextType::class,[
                        'label' => 'Estado',
                        'mapped' => false,
                        'attr' => ['class' => 'form-control-sm is-invalid', 'value' => 'Codigo postal es invalido', 'disabled' => true],
                    ])
                    ;
                }
            }else{
        ...
        $builder->addEventListener(
            ...
            function (FormEvent $event) use ($formModifier, $entityManager, $direccion) {
                // this would be your entity, i.e. SportMeetup
                $data = $event->getData();
                $municipio = $data->getCodigoPostalColonia();
                if($municipio){
                    $formModifier($event->getForm(), $municipio->getCodigo(), $entityManager, $direccion);
                }else{
        ...
        $builder->get('codigoPostalColoniaNoMapped')->addEventListener(
            ...
            function (FormEvent $event) use ($formModifier, $entityManager, $direccion) {
                ...
                $formModifier($event->getForm()->getParent(), $codigoPostal, $entityManager, $direccion);
            }
        );
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        ...
        $resolver->setRequired('direccion');
