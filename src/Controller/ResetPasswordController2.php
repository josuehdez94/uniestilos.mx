 ...
 */
class ResetPasswordController2 extends AbstractController
{
     ...
     *
     * @Route("", name="app_forgot_password_request2")
     */
     ...
     *
     * @Route("/check-email", name="app_check_email2")
     */
     ...
     *
     * @Route("/reset/{token}", name="app_reset_password2")
     */
